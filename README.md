...
$$Sh_i(N,v) = \sum_{S \subseteq N\backslash \lbrace i \rbrace} \frac{(n-1-|S|)!\cdot|S|!}{n!} (v(S\cup \lbrace i \rbrace)-v(S))$$

$$= \sum_{S \subseteq N\backslash \lbrace i \rbrace} \left(\frac{n!}{(n-1-|S|)!\cdot|S|!}\right)^{-1} (v(S\cup \lbrace i \rbrace)-v(S))$$

$$= \sum_{S \subseteq N\backslash \lbrace i \rbrace} \left(\underbrace{\frac{n!}{(n-|S|)!\cdot|S|!}}_{\text{binomial coefficient}}(n-|S|)\right)^{-1} (v(S\cup \lbrace i \rbrace)-v(S))$$

$$= \sum_{S \subseteq N\backslash \lbrace i \rbrace} \left( \binom{n}{|S|} (n-|S|)\right)^{-1} (v(S\cup \lbrace i \rbrace)-v(S))$$

$$= \sum_{S \subseteq N\backslash \lbrace i \rbrace} \frac{1}{\binom{n}{|S|} (n-|S|)} (v(S\cup \lbrace i \rbrace)-v(S))$$
